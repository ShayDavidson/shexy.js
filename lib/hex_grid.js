import { AXIAL_ZERO, axialsInRange, vertexFromId, vertexNeighbors, areVerticesEquivalent, vertexUniqueId } from './hex_coords'
...
export class VertexMap {
	...
	set(vertex, value) {
		this.hash[vertexUniqueId(vertex)] = value
	}

	get(vertex) {
		return this.hash[vertexUniqueId(vertex)]
	}

	delete(vertex) {
		delete this.hash[vertexUniqueId(vertex)]
	}
}
